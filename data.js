...
const siteData = {
    ...
    president: {
        ...
        title: "順德龍山同鄉會會長",
        // 請替換此處的圖片連結
        photo: "https://via.placeholder.com/300x400?text=會長照片", 
        paragraphs: [
    ...
    news: [
        {
            ...
            image: "https://via.placeholder.com/400x300?text=活動封面+1",
            content: "本次新春團拜活動是疫情後首次大規模線下聚會，現場氣氛熱烈，鄉親們互道祝福。會長張大山先生在致辭中回顧了過去一年的工作，並對新一年的發展進行了展望。活動包括文藝表演、抽獎環節及豐富的午宴。",
            detailImages: [
                "https://via.placeholder.com/600x400?text=照片+1",
                "https://via.placeholder.com/600x400?text=照片+2",
                "https://via.placeholder.com/600x400?text=照片+3",
                "https://via.placeholder.com/600x400?text=照片+4 (測試滾動)"
            ]
        },
        {
            id: 2,
            ...
            image: "https://via.placeholder.com/400x300?text=活動封面+2",
        ...
        },
        {
            ...
            image: "https://via.placeholder.com/400x300?text=活動封面+3",
        ...
        },
        {
            ...
            image: "https://via.placeholder.com/400x300?text=活動封面+4",
        ...
        },
        {
            ...
            image: "https://via.placeholder.com/400x300?text=活動封面+5",
        ...
        },
        {
            ...
            image: "https://via.placeholder.com/400x300?text=活動封面+6",
    ...
    // 5. 龍山風采 (不變)
    gallery: [
        "https://via.placeholder.com/400x300?text=風采+1",
        "https://via.placeholder.com/400x300?text=風采+2",
        "https://via.placeholder.com/400x300?text=風采+3",
        "https://via.placeholder.com/400x300?text=風采+4",
        "https://via.placeholder.com/400x300?text=風采+5",
        "https://via.placeholder.com/400x300?text=風采+6",
        "https://via.placeholder.com/400x300?text=風采+7",
        "https://via.placeholder.com/400x300?text=風采+8"
    ],
